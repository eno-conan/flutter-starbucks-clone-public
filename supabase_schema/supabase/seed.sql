...
VALUES
  ...
  ('0026', '大宮駅東口店', 11, '埼玉県さいたま市大宮区桜木町2-1-1', '08:00', '22:00', '2021-04-01', NULL, '0',  35.906654, 139.623895),
  ('0027', '川越駅前店', 11, '埼玉県川越市脇田本町1-1', '09:00', '21:30', '2021-09-15', NULL, '0',  35.925277, 139.485855),
  ('0028', '浦和駅前店', 11, '埼玉県さいたま市浦和区高砂1-1-1', '08:30', '22:00', '2022-01-20', NULL, '0',  35.859398, 139.655437),
  ('0029', '宇都宮駅前店', 9, '栃木県宇都宮市川向町1-1', '09:00', '21:00', '2020-10-01', NULL, '0',  36.554872, 139.882564),
  ('0030', '日光駅前店', 9, '栃木県日光市相生町1-1', '10:00', '19:00', '2022-05-03', NULL, '0',  36.745272, 139.604309),
  ('0031', '足利駅前店', 9, '栃木県足利市伊勢町1-1', '08:30', '20:30', '2021-06-20', NULL, '0',  36.339148, 139.448978),
  ('0032', '前橋駅前店', 10, '群馬県前橋市表町1-1-1', '09:00', '21:00', '2020-07-15', NULL, '0',  36.390856, 139.060861),
  ('0033', '高崎駅東口店', 10, '群馬県高崎市八島町1-1', '08:00', '22:00', '2021-03-01', NULL, '1',  36.322617, 139.004005),
  ('0034', '太田駅南口店', 10, '群馬県太田市飯田町1-1', '09:30', '21:30', '2022-07-10', NULL, '0',  36.293165, 139.376437),
  ('0035', '京都駅前店', 26, '京都府京都市下京区烏丸通塩小路下ル1-1', '08:00', '22:30', '2020-03-01', NULL, '0',  34.985648, 135.758829),
  ('0036', '広島駅前店', 34, '広島県広島市南区松原町1-1', '09:00', '21:00', '2021-11-03', NULL, '0',  34.397440, 132.475937),
  ('0037', '静岡駅前店', 22, '静岡県静岡市葵区黒金町1-1', '08:30', '21:30', '2020-05-20', NULL, '0',  34.971652, 138.388727),
  ('0038', '金沢駅前店', 17, '石川県金沢市木ノ新保町1-1', '09:00', '21:00', '2021-08-01', NULL, '0',  36.578293, 136.648003),
  ('0039', '松山駅前店', 38, '愛媛県松山市宮田町1-1', '08:30', '20:30', '2022-03-15', NULL, '0',  33.842820, 132.765553),
  ('0040', '鹿児島中央駅前店', 46, '鹿児島県鹿児島市中央町1-1', '09:00', '21:30', '2021-10-10', NULL, '0',  31.590099, 130.542397);
...
INSERT INTO "public"."orders" ("id", "order_id", "user_id", "store_number", "usage", "order_type", "pickup_number", "price_without_tax", "price_with_tax", "payment_method", "provided_status", "created_at", "updated_at")
VALUES
('a1000001-0000-0000-0000-000000000001', 'order_arch_0001', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0001', '1', '1', 'ｱｰｶｲﾌﾞ*01', '650',  '702',  'クレジットカード', '2', '2023-01-15 09:00:00+00', '2023-01-15 09:00:00+00'),
('a1000001-0000-0000-0000-000000000002', 'order_arch_0002', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0003', '2', '2', 'ｱｰｶｲﾌﾞ*02', '700',  '756',  'クレジットカード', '2', '2023-03-20 11:30:00+00', '2023-03-20 11:30:00+00'),
('a1000001-0000-0000-0000-000000000003', 'order_arch_0003', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0011', '1', '1', 'ｱｰｶｲﾌﾞ*03', '800',  '864',  'クレジットカード', '2', '2023-05-10 08:15:00+00', '2023-05-10 08:15:00+00'),
('a1000001-0000-0000-0000-000000000004', 'order_arch_0004', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0006', '2', '2', 'ｱｰｶｲﾌﾞ*04', '1100', '1188', 'クレジットカード', '2', '2023-07-25 14:45:00+00', '2023-07-25 14:45:00+00'),
('a1000001-0000-0000-0000-000000000005', 'order_arch_0005', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0003', '1', '1', 'ｱｰｶｲﾌﾞ*05', '450',  '486',  'クレジットカード', '2', '2023-09-08 10:00:00+00', '2023-09-08 10:00:00+00'),
('a1000001-0000-0000-0000-000000000006', 'order_arch_0006', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0011', '2', '2', 'ｱｰｶｲﾌﾞ*06', '950',  '1026', 'クレジットカード', '2', '2023-11-30 16:20:00+00', '2023-11-30 16:20:00+00'),
('a1000001-0000-0000-0000-000000000007', 'order_arch_0007', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0002', '1', '1', 'ｱｰｶｲﾌﾞ*07', '350',  '378',  'クレジットカード', '2', '2024-01-14 07:30:00+00', '2024-01-14 07:30:00+00'),
('a1000001-0000-0000-0000-000000000008', 'order_arch_0008', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0003', '2', '2', 'ｱｰｶｲﾌﾞ*08', '1050', '1134', 'クレジットカード', '2', '2024-03-22 12:00:00+00', '2024-03-22 12:00:00+00'),
('a1000001-0000-0000-0000-000000000009', 'order_arch_0009', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0011', '1', '1', 'ｱｰｶｲﾌﾞ*09', '750',  '810',  'クレジットカード', '2', '2024-06-05 09:45:00+00', '2024-06-05 09:45:00+00'),
('a1000001-0000-0000-0000-000000000010', 'order_arch_0010', 'eecd2638-c80a-47c1-9105-eb0856fd5345', '0006', '2', '2', 'ｱｰｶｲﾌﾞ*10', '900',  '972',  'クレジットカード', '2', '2024-09-01 13:10:00+00', '2024-09-01 13:10:00+00');
